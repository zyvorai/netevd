...
hero:
  ...
  highlights:
    ...
    - {value: "17", label: "hook directories", footnote: "1"}
    - {value: "<100ms", label: "netlink event latency"}
    - {value: "eBPF", label: "observe-only drops / TCP"}
  ...
  hub_bands:
    ...
    - {icon: "📡", title: "Observe-only eBPF", description: "Packet drops, TCP retransmit, and TCP reset hooks.", href: user/ebpf.md}
...
footnotes:
  - {marker: "1", text: "17 hook directories span carrier/link, address, route, MTU, manager state, and observe-only eBPF (drops / tcp-retransmit / tcp-reset).", href: hooks-contract.md, href_label: "See the Hook Contract."}
...
- [Changelog](https://github.com/zyvorai/netevd/blob/main/CHANGELOG.md) — 0.4.1 notes (Ubuntu 26.04 image, Alpine 3.23, remote deploy)
