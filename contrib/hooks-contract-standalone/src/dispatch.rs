...
use crate::execute::{execute_scripts, execute_scripts_with_timeout};
use crate::validation::validate_state_name;
...
mod tests {
    ...
    async fn dispatch_runs_executable_and_sets_env() {
        ...
        assert_eq!(lines, ["eth0", "address-added", "192.168.1.10", "address-added"]);
    }
